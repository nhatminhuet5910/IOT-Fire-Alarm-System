...
const int checkPin = 12; // Thay đổi chân này tùy thuộc vào cấu hình của bạn
/* ======================================== */
#define emailSenderAccount      "baochayesp32@gmail.com"
#define emailSenderAppPassword  "enfa agsq yknk mvgm"
#define smtpServer              "smtp.gmail.com"
#define smtpServerPort          465
#define emailSubject            "ESP32-CAM Cảnh báo cháy"
#define emailRecipient          "chauhoangyen58611@gmail.com" // Thay đổi email của bạn để nhận tin nhắn.
/* ======================================== */
...
// Đổi tài khoản và mật khẩu wifi.

const char* ssid = "THPTCONGHOA";
...
void sendPhoto( void ) {
  ...
  smtpData.setSender("ESP32 Cảnh Báo Cháy", emailSenderAccount); 
  ...
  smtpData.setMessage("<h2>Đây là tin nhắn chứa hình ảnh báo cháy.</h2>", true); 
...
void setup() {
  ...
  Serial.println("Wait 30 seconds for thesensor to stabilize.");

...
#define emailSenderPassword   "enfa agsq yknk mvgm"
#define smtpServer            "smtp.gmail.com"
#define smtpServerPort        465
#define emailSubject          "ESP32-CAM Photo Captured"
#define emailRecipient        "nhatminhlio100@gmail.com"
...
void loop() {
 if (Serial.available() > 0) {
  ...
  delay(1000);
 int digitalValue = digitalRead(checkPin);
 Serial.println(digitalValue);
  if (digitalValue == 1){
    Serial.println("Chup hinh va gui");
